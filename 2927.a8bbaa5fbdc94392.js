  ...
  forgotPassword() {
    ...
    if (this.isValid1()) {
      ...
      this.authenticationService.forgotPassword(this.data).subscribe(/*#__PURE__*/function () {
        var _ref = (0,_Users_ahemad_Documents_officeWorkspace_customerApp_finalcal_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (result) {
  ...
  changePassword() {
    ...
    if (this.response != undefined) {
      ...
      this.authenticationService.changePassword(resetData).subscribe(/*#__PURE__*/function () {
        var _ref2 = (0,_Users_ahemad_Documents_officeWorkspace_customerApp_finalcal_ts_operator_ionic4_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (result) {
